...
console.log(newCardName.parentNode);
 ...
 /* for add new item */
// let popupBoxItem = document.getElementById("popupboxitem") 
// let newListItem = document.getElementById("additemname")
...
function addCard()
{
  ...
  /*  let itemId = 0;
    itemAdd.addEventListener('click',function(popupboxitem)
    {
